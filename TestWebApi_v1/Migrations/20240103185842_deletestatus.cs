        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkedAsDeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomId = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    MangaId = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    TimeStart = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    EndTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__ChatRoom__32863939EEE78146", x => x.RoomId);
                    table.ForeignKey(
                        name: "FK_Botruyen_RoomChat",
                        column: x => x.MangaId,
                        principalTable: "BoTruyen",
                        principalColumn: "MangaId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserJoin__E3FEB5FD75AD19C1", x => new { x.RoomId, x.UserId });
                    table.ForeignKey(
                        name: "FK_RoomChat_UserJoinChat",
                        column: x => x.RoomId,
                        principalTable: "ChatRoom",
                        principalColumn: "RoomId");
                    table.ForeignKey(
                        name: "FK_User_UserJoinChat",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeChat = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Datachat__A9FBE7C60DDBADDF", x => x.ChatId);
                    table.ForeignKey(
                        name: "FK_Datachat_UserJoinChat",
                        columns: x => new { x.RoomId, x.UserId },
                        principalTable: "UserJoinChat",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Datachat_RoomId_UserId",
                table: "Datachat",
